...
import {
  makeSelectSuccess, makeSelectResponse, makeSelectError, makeSelectRequesting, makeSelectUserId, makeSelectResendEmailRequesting,
} from './selectors';
...
class ForgotPassword extends React.Component {
  ...
  render() {
    ...
    return (
      <Modal
        open onClose={this.props.hideDialog} className="mini" closeIcon
      >
        <Modal.Content>
          {errorResponse &&
